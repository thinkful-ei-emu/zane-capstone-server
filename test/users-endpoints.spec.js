...
describe('User Endpoints',function(){
  ...
  describe('POST/api/users',()=>{
    context('user validation',()=>{
      ...
      const requiredFields=['password','user_name','user_email','first_name','last_name'];
      ...
      it('responds 400 \'Password be less than 72 characters\' when long password', () => {
        ...
        return supertest(app)
          ...
          .expect(400, { error: 'Password length must be less than 72 characters' });
      });
      ...
      it('responds 400 error when password isn\'t complex enough', () => {
        ...
        return supertest(app)
          ...
          .send(userPasswordNotComplex)
          .expect(400, {
            error: 'Password must have at least one uppercase character, lowercase character, number, and special character'
          });
      });
